...
@Component({
    selector       : 'evid-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    styles         : [],
    animations     : EvidAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class EvidVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    // Auto collapse
    @Input()
    ...
    // Collapsed
    @HostBinding('class.evid-vertical-navigation-item-collapsed')
    isCollapsed: boolean;

    // Expanded
    @HostBinding('class.evid-vertical-navigation-item-expanded')
    isExpanded: boolean;
    ...
    ngOnInit(): void
    {
        ...
        this._EvidVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._EvidVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._EvidVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._EvidVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
