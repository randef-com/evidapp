...
export class EvidNavigationService
{
    // Private
    private _componentRegistry: Map<string, any>;
    private _navigationStore: Map<string, EvidNavigationItem[]>;
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: EvidNavigationItem[]): void
    {
        // Add to the store
     ...
     * @returns {any}
     */
    getNavigation(key: string): EvidNavigationItem[]
    {
     ...
     * @returns {EvidNavigationItem[]}
     */
    getFlatNavigation(navigation: EvidNavigationItem[], flatNavigation: EvidNavigationItem[] = []): EvidNavigationItem[]
    {
     ...
     * @param navigation
     */
    getItem(id: string, navigation: EvidNavigationItem[]): EvidNavigationItem | null
    {
        for ( const item of navigation )
        {
            if ( item.id === id )
    ...
    getItemParent(
        id: string,
        navigation: EvidNavigationItem[],
        parent: EvidNavigationItem[] | EvidNavigationItem
    ): EvidNavigationItem[] | EvidNavigationItem | null
    {
        for ( const item of navigation )
        {
            if ( item.id === id )
