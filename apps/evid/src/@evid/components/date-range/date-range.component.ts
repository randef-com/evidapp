...
@Component({
    selector     : 'evid-date-range',
    templateUrl  : './date-range.component.html',
    styleUrls    : ['./date-range.component.scss'],
    encapsulation: ViewEncapsulation.None,
    exportAs     : 'evidDateRange',
    providers    : [
        {
            provide    : NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => EvidDateRangeComponent),
            multi      : true
        }
    ]
})
export class EvidDateRangeComponent implements ControlValueAccessor, OnInit, OnDestroy
{
    // Range changed
    @Output()
    ...
    // Private
    @HostBinding('class.evid-date-range')
    ...
    openPickerPanel(): void
    {
        ...
        const overlayRef = this._overlay.create({
            panelClass      : 'evid-date-range-panel',
            backdropClass   : '',
            hasBackdrop     : true,
