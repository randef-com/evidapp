...
import { EvidHighlightService } from './highlight.service';

@Component({
    selector       : 'textarea[evid-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'EvidHighlight'
})
export class EvidHighlightComponent implements AfterViewInit
{
     ...
     * @param {EvidHighlightService} _EvidHighlightService
    ...
    constructor(
        ...
        private _EvidHighlightService: EvidHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._EvidHighlightService.highlight(this.code, this.lang));
