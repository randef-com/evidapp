...
import { EvidDrawerMode, EvidDrawerPosition } from './drawer.types';
import { EvidDrawerService } from './drawer.service';

@Component({
    selector     : 'evid-drawer',
    templateUrl  : './drawer.component.html',
    styleUrls    : ['./drawer.component.scss'],
    encapsulation: ViewEncapsulation.None,
    exportAs     : 'EvidDrawer'
})
export class EvidDrawerComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    private _mode: EvidDrawerMode;
    private _opened: boolean | '';
    private _overlay: HTMLElement | null;
    private _player: AnimationPlayer;
    private _position: EvidDrawerPosition;
    ...
    // On mode changed
    @Output()
    readonly modeChanged: EventEmitter<EvidDrawerMode>;
    ...
    // On position changed
    @Output()
    readonly positionChanged: EventEmitter<EvidDrawerPosition>;

    @HostBinding('class.evid-drawer-animations-enabled')
     ...
     * @param {EvidDrawerService} _EvidDrawerService
     */
    constructor(
        private _animationBuilder: AnimationBuilder,
        private _elementRef: ElementRef,
        private _renderer2: Renderer2,
        private _EvidDrawerService: EvidDrawerService
    )
    {
        ...
        this.modeChanged = new EventEmitter<EvidDrawerMode>();
        this.openedChanged = new EventEmitter<boolean | ''>();
        this.positionChanged = new EventEmitter<EvidDrawerPosition>();
    ...
    set fixed(value: boolean)
    {
        ...
        if ( this.fixed )
        {
            this._renderer2.addClass(this._elementRef.nativeElement, 'evid-drawer-fixed');
        }
        else
        {
            this._renderer2.removeClass(this._elementRef.nativeElement, 'evid-drawer-fixed');
        }
    ...
    set mode(value: EvidDrawerMode)
    {
        ...
        modeClassName = 'evid-drawer-mode-' + this.mode;
    ...
    set opened(value: boolean | '')
    {
        ...
        if ( this.opened )
        {
            ...
            this._renderer2.addClass(this._elementRef.nativeElement, 'evid-drawer-opened');
        }
        else
        {
            this._renderer2.setStyle(this._elementRef.nativeElement, 'visibility', 'hidden');
            this._renderer2.removeClass(this._elementRef.nativeElement, 'evid-drawer-opened');
        }
     ...
     */
    @Input()
    set position(value: EvidDrawerPosition)
    {
        // If the value is the same, return...
        ...
        positionClassName = 'evid-drawer-position-' + this.position;
    ...
    get position(): EvidDrawerPosition
    {
    ...
    {
        // Register the drawer
        this._EvidDrawerService.registerComponent(this.name, this);
    }
    ...
    ngOnDestroy(): void
    {
        ...
        this._EvidDrawerService.deregisterComponent(this.name);
    }
    ...
    private _showOverlay(): void
    {
        ...
        this._overlay.classList.add('evid-drawer-overlay');

        // Add a class depending on the fixed option
        if ( this.fixed )
        {
            this._overlay.classList.add('evid-drawer-overlay-fixed');
        }

        // Add a class depending on the transparentOverlay option
        if ( this.transparentOverlay )
        {
            this._overlay.classList.add('evid-drawer-overlay-transparent');
        }
    ...
    private _onMouseenter(): void
    {
        ...
        // Add a class
        this._renderer2.addClass(this._elementRef.nativeElement, 'evid-drawer-hover');
    }
    ...
    private _onMouseleave(): void
    {
        ...
        // Remove the class
        this._renderer2.removeClass(this._elementRef.nativeElement, 'evid-drawer-hover');
    }
