...
// -----------------------------------------------------------------------------------------------------
@Directive({
    selector: '[evidScrollbar]',
    exportAs: 'evidScrollbar'
})
export class EvidScrollbarDirective implements OnInit, OnDestroy
{
    isMobile: boolean;
     ...
     */
    @Input()
    set evidScrollbarOptions(value: any)
    {
        // Merge the options
    ...
    private _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this._elementRef.nativeElement, {...this.evidScrollbarOptions});
    }
