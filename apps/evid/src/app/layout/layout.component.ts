...
import {EvidConfigService} from "../../@evid/services/config";
...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        combineLatest([
            this._evidConfigService.config$,
            this._evidMediaWatcherService.onMediaQueryChange$(['(prefers-color-scheme: dark)', '(prefers-color-scheme: light)'])
        ]).pipe(
    ...
    private _updateTheme(): void
    {
        ...
        this._document.body.classList.forEach((className) => {
            if ( className.startsWith('evid-theme-') )
            {
        ...
        this._document.body.classList.add('evid-theme-' + this.theme);
    }
    ...
    setLayout(layout: string): void
    {
        ...
        this._router.navigate([], {
            ...
            // Set the config
            this._evidConfigService.config = {layout};
        });
    }
    ...
    {
        this._evidConfigService.config = {theme: change.value};
    }
}
