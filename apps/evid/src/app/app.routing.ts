    ...
    children: [
      ...
      // Dashboards
      {
        path: 'dashboards', children: [
          {
            path: 'finance',
            loadChildren: () => import('./modules/admin/dashboards/finance/finance.module').then(m => m.FinanceModule)
          },
        ]
      },
      ...
      // Apps
      {
        path: 'apps', children: [
          {
            path: 'calendar',
            loadChildren: () => import('./modules/admin/apps/calendar/calendar.module').then(m => m.CalendarModule)
          },
          {
            path: 'contacts',
            loadChildren: () => import('./modules/admin/apps/contacts/contacts.module').then(m => m.ContactsModule)
          },
        ]
      },
      ...
      // 404 & Catch all
      {
        path: '404-not-found',
        pathMatch: 'full',
        loadChildren: () => import('./modules/admin/pages/errors/error-404/error-404.module').then(m => m.Error404Module)
      },
